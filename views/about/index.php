<?php include ROOT . '/views/template/header/headerAbout.php'; ?>

<!--Main Section-->
<div class="row">
<div class="col-md-12 spacing"></div>
<div class="ml-auto col-xs-12 col-sm-12 col-md-10 col-lg-10 col-xl-8 aboutDescriptionSection mr-auto text-center">

    
<div class="col-md-12 spacing"></div>
    <hr>
    <p>Сайт для настоящих и бывших актёров театра, студентов отделения ТТ АКИ, и поклонников театрального искусства.</p>
    <hr>
    <div class="col-md-12 spacing"></div>
    <div class="col-md-12 spacing"></div>
    <div class="col-md-12 spacing"></div>
